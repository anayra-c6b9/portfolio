...
export class BlogCardComponent {
  @Input() cardInfo: BlogCard = {
    ...
    description:
      'It has been three years since, we can see the rise of the use of A.I. in our day to day life. It has been three years since, we can see the rise of the use of A.I. in our day to day life. in our day to day life. in our day to day life.',
    link: '',
    id: '',
    image_source:
